...
async function runClick(event){
  ...
  event.preventDefault();
    ...
    mainTemp.textContent = jsonData.current.temp + " \u00B0" + "F";
    ...
    d1temp.textContent = "Temp: " + jsonData.daily[1].temp.day + " \u00B0" + "F";
    d1wind.textContent = "Wind: " + jsonData.daily[1].wind_speed + " mph";
    ...
    d2temp.textContent = "Temp: " + jsonData.daily[2].temp.day + " \u00B0" + "F";
    d2wind.textContent = "Wind: " + jsonData.daily[2].wind_speed + " mph";
    ...
    d3temp.textContent = "Temp: " + jsonData.daily[3].temp.day + " \u00B0" + "F";
    d3wind.textContent = "Wind: " + jsonData.daily[3].wind_speed + " mph";
    ...
    d4temp.textContent = "Temp: " + jsonData.daily[4].temp.day + " \u00B0" + "F";
    d4wind.textContent = "Wind: " + jsonData.daily[4].wind_speed + " mph";
    ...
    d5temp.textContent = "Temp: " + jsonData.daily[5].temp.day + " \u00B0" + "F";
    d5wind.textContent = "Wind: " + jsonData.daily[5].wind_speed + " mph";
